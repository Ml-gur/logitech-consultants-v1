...
const testimonials = [
  {
    quote: '\u201CAIthor killed two of our pet projects and saved us a fortune. Honest advice we couldn\u2019t get internally.\u201D',
    name: 'Lucas Bennett',
    role: 'CEO & Founder',
    avatar: '/images/74bgmTCLhG1vjdwC6jrte1Upppk.png',
  },
  {
    quote: '\u201CEvery recommendation tied back to a real number on the P&L. Strategic, reliable, and genuinely tailored to us.\u201D',
    name: 'Benjamin Daul',
    role: 'Head of Engineering',
    avatar: '/images/u2w7SaaM0N5ieDRzqCOPmRhPOc.png',
  },
  {
    quote: '\u201COur team now runs the playbooks on their own. That\u2019s the kind of partner that builds capability, not dependency.\u201D',
    name: 'Emma Collins',
    role: 'Head of Content',
    avatar: '/images/IMZdofzqqJ3H2GANrvn50i2D9qo.png',
  },
  {
  ...
  },
  {
    ...
    avatar: '/images/YA3AGELH6hUZToUz17fZAzd0yo.png',
  },
]

function ReviewCard({ quote, name, role, avatar }: (typeof testimonials)[number]) {
  return (
    <figure className="group relative w-[320px] max-md:w-[280px] cursor-pointer overflow-hidden rounded-[16px] border border-black/[0.06] bg-[#f0f0f0] p-5 transition-colors duration-300 hover:bg-white">
      ...
      <div className="section-panel section-panel-light" style={{ borderRadius: '50px' }}>
        <div className="section-inner">
          ...
          >
            ...
            {/* Fade edges */}
            <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-[#e5e5e5] to-transparent" />
            <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-[#e5e5e5] to-transparent" />
          </motion.div>
        </div>
      </div>
    </section>
