...
export default function BuyTemplate() {
  return (
    <a
      ...
      className="fixed bottom-[60px] right-[20px] z-40 flex h-[145px] w-[142px] flex-col items-center justify-center gap-3 rounded-[10px] bg-[#1c1c1c] transition-colors duration-300 hover:bg-[#0a0a0a] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#ff3700]"
    >
