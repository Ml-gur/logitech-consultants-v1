      ...
      <section className="relative pt-[76px]">
        <div className="section-panel section-panel-dark rounded-[50px]">
          <div className="section-inner text-center py-24">
            <h1 className="font-['Halant'] text-4xl font-semibold text-[#f0f0f0] mb-4">Case study not found</h1>
            <Link to="/case-studies" className="text-sm text-[#999] hover:text-[#f0f0f0] transition-colors">
      ...
      <div className="section-panel section-panel-dark rounded-[50px]">
        <div className="section-inner">
          <motion.div initial={revealInitial} whileInView={revealWhileInView} viewport={revealViewport} transition={springReveal()}>
            <Link to="/case-studies" className="inline-flex items-center gap-2 text-sm text-[#999] hover:text-[#f0f0f0] transition-colors mb-8">
          ...
          <motion.div initial={revealInitial} whileInView={revealWhileInView} viewport={revealViewport} transition={springReveal(0.06)} className="mb-16">
            <div className="flex flex-wrap items-center gap-3 mb-6">
              <span className="text-xs font-medium text-[#999] uppercase tracking-wider">{c.category}</span>
              <span className="w-1 h-1 rounded-full bg-[#4f4f4f]" />
              <span className="text-xs text-[#999]">{c.year} · {c.timeframe}</span>
            </div>
            <h1 className="font-['Halant'] text-[clamp(40px,6vw,80px)] font-semibold leading-[1.05] tracking-tight text-[#f0f0f0] max-w-[760px] mb-6">
              {c.name}
            </h1>
            <p className="text-lg text-[#999] max-w-[560px] leading-relaxed">{c.tagline}</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-[1fr_360px] gap-16 lg:gap-24 mb-20">
            <div className="space-y-16 max-w-[720px]">
              <motion.div initial={revealInitial} whileInView={revealWhileInView} viewport={revealViewport} transition={springReveal()}>
                ...
                <p className="text-base text-[#e5e5e5] leading-relaxed">{c.challenge}</p>
              </motion.div>

              <motion.div initial={revealInitial} whileInView={revealWhileInView} viewport={revealViewport} transition={springReveal()}>
                <p className="section-label">What We Built</p>
                <p className="text-base text-[#e5e5e5] leading-relaxed">{c.build}</p>
              </motion.div>
              ...
              <motion.div initial={revealInitial} whileInView={revealWhileInView} viewport={revealViewport} transition={springReveal()}>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                  {c.outcome.map((m) => (
                    <div key={m.label} className="border border-white/5 rounded-2xl p-6 bg-[#151619]">
                      <div className="text-3xl font-semibold text-[#f0f0f0] font-['Halant'] mb-2">{m.value}</div>
